...
impl SnapshotRestorer {
        ...
        <S as ReadStore>::Error: std::error::Error,
    {
        ...
        let checkpoint_sync_handle = spawn_monitored_task!(async move {
            archive_reader
                .load_summaries_upto(epoch.saturating_add(1), summary_sync_store)
                .await
    ...
    async fn setup_db_state(
        ...
        checkpoint_store.update_highest_pruned_checkpoint(&last_checkpoint)?;
